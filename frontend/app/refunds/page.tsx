        ...
        <div className="space-y-8 text-sm leading-relaxed text-gray-700 dark:text-gray-300">
          ...
          <section>
            <div className="bg-indigo-50 dark:bg-indigo-900/20 border border-indigo-100 dark:border-indigo-800 rounded-xl px-4 py-4 mb-6">
              <p className="text-indigo-800 dark:text-indigo-200 font-medium">Short version: if RelocationHub doesn&rsquo;t work for you in the first 14 days, email us and we&rsquo;ll refund you — no questions asked.</p>
            </div>
          </section>
          ...
          <section>
            ...
            <p className="mt-2">If you purchased RelocationHub Pro (€19.99 one-time) and are not satisfied for any reason, email us within 14 days of your purchase date and we will process a full refund. No justification required.</p>
